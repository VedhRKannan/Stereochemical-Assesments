...
def main():
    ...
    parser = argparse.ArgumentParser(
                    prog='Extract angles',
                    description='Extract the torsion angles'
                    )
    parser.add_argument('-i', "--input", help="the filename of the structure.") 
    parser.add_argument("-o", '--output', help="the tsv file of torsion angles") 
